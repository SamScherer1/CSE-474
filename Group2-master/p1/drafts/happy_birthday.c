...
int main() {
	...
	while(1) {
		...
		// 8 notes G-GA-BCB
		// periods of notes in microseconds: G = 2551, A = 4545, B = 4050, C = 3822
		switch (count) {
			case 0:
				fprintf(periodPWM, "%d", 2551);
				break;
			case 1:
				fprintf(periodPWM, "%d", 2551);
				break;
			case 2:
				fprintf(periodPWM, "%d", 2251);
				break;
			case 3:
				fprintf(periodPWM, "%d", 4545);
				break;
			case 4:
				fprintf(periodPWM, "%d", 4545);
				break;
			case 5:
				...
				break;
			case 6:
				fprintf(periodPWM, "%d", 3822);
				break;
			case 7:
				fprintf(periodPWM, "%d", 4050);
				break;
			default:
				fprintf(periodPWM, "%d", 8000); // bad note for default
				break;
		}
		fflush(periodPWM);
